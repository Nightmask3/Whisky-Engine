...
{
public:
	SFX(string sfxName) : mCurrentSFXName_(sfxName){};
	virtual ~SFX();
	...
	virtual string getCurrentSFXName() const { return mCurrentSFXName_; }
	virtual void setCurrentSFXName(string newCurrentSFXName) { mCurrentSFXName_ = newCurrentSFXName; }
private:
	string mCurrentSFXName_;
};
